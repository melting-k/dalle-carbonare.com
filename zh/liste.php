...
if($categorie=="instrument"){$titre_general="樂器";$sous_titre_general="我們的樂器";$var1=1;$var2=2;$var3=3;$var4=4;$var5=5;if($categorie_id==""){$categorie_id=1;}}
if($categorie=="archet"){$titre_general="琴弓";$sous_titre_general="我们的琴弓";$var1=6;$var2=7;$var3=8;$var4=9;$var5=10;if($categorie_id==""){$categorie_id=6;}}
if($categorie=="accessoire"){$titre_general="附件";$sous_titre_general="我們的配件";$var1=11;$var2=12;$var3=13;$var4=14;$var5=15;if($categorie_id==""){$categorie_id=11;}}
            ...
            <div class="content-holder" id="point1" style="background-image: url('build/images/img22.jpg');">
                <div class="container">
                    <nav class="instrument-navigation">
                        <ul>
                            <li class="<?echo $classe1;?>"><a href="liste.php?categorie=<?echo $categorie;?>&categorie_id=<?echo $var1;?>&lang=chinese" class="btn btn-green"><span>小提琴</span> <i class="icon-arrow_right"></i></a></li>
                            <li class="<?echo $classe2;?>"><a href="liste.php?categorie=<?echo $categorie;?>&categorie_id=<?echo $var2;?>&lang=chinese" class="btn btn-green"><span>中音</span> <i class="icon-arrow_right"></i></a></li>
                            <li class="<?echo $classe3;?>"><a href="liste.php?categorie=<?echo $categorie;?>&categorie_id=<?echo $var3;?>&lang=chinese" class="btn btn-green"><span>大提琴</span> <i class="icon-arrow_right"></i></a></li>
                            <li  class="<?echo $classe4;?>"><a href="liste.php?categorie=<?echo $categorie;?>&categorie_id=<?echo $var4;?>&lang=chinese" class="btn btn-green"><span>貝司</span> <i class="icon-arrow_right"></i></a></li>
                            <li  class="<?echo $classe5;?>"><a href="liste.php?categorie=<?echo $categorie;?>&categorie_id=<?echo $var5;?>&lang=chinese" class="btn btn-green"><span>巴洛克</span> <i class="icon-arrow_right"></i></a></li>
                        </ul>
                    </nav>
                    <ul class="instrument-list">
						...
						<li class="instrument-box">
                            ...
                            <div class="watch-holder">
                                <a href="detail.php?categorie=<?echo $categorie;?>&categorie_id=<?echo $instrument->categorie_id;?>&instrument_id=<?echo $instrument->id;?>&lang=chinese" >
