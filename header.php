...
<head>
    ...
    <meta name="description"
        content="Atelier Dalle Carbonare, luthier à Toulouse. Plus de 20 ans d'expérience pour un savoir-faire unique et reconnu dans l'entretien et la fabrication de violons et d'archets" />
    ...
    <meta name="description"
        content="Présentation de Pierre-Yves Dalle Carbonare et de son atelier de lutherie à Toulouse. Découvrez sa formation, et une galerie de photos de notre atelier toulousain" />
    <?php } if($categorie=="instrument" && $categorie_id==1) { ?>
    <title>Nos instruments : découvrez nos violons à Toulouse</title>
    <meta name="description"
        content="Découvrez les instruments proposés par l'atelier Dalle Carbonare, à Toulouse. Présentation de nos modèles de violons disponibles en achat ou location" />
    <?php } if($categorie=="instrument" && $categorie_id==2 ) { ?>
    <title>Nos instruments : découvrez nos altos à Toulouse</title>
    <meta name="description"
        content="Découvrez les instruments proposés par l'atelier Dalle Carbonare, à Toulouse. Présentation de nos modèles d'altos disponibles en achat ou location" />
    <?php } if($categorie=="instrument" && $categorie_id==3 ) { ?>
    <title>Nos instruments : découvrez nos violoncelles à Toulouse</title>
    <meta name="description"
        content="Découvrez les instruments proposés par l'atelier Dalle Carbonare, à Toulouse. Présentation de nos modèles de violoncelles disponibles en achat ou location" />
    <?php } if($categorie=="instrument" && $categorie_id==4 ) { ?>
    <title>Nos instruments : découvrez nos contrebasses à Toulouse</title>
    <meta name="description"
        content="Découvrez les instruments proposés par l'atelier Dalle Carbonare, à Toulouse. Présentation de nos modèles de contrebasses disponibles en achat ou location" />
    <?php } if($categorie=="instrument" && $categorie_id==5 ) { ?>
    <title>Nos instruments : découvrez nos instruments baroques à Toulouse</title>
    <meta name="description"
        content="Découvrez les instruments proposés par l'atelier Dalle Carbonare, à Toulouse. Présentation de nos modèles d'instruments baroques disponibles en achat ou location" />

    <?php } if($categorie=="archet" && $categorie_id==6) { ?>
    <title>Nos archets : découvrez nos archets de violons à Toulouse</title>
    <meta name="description"
        content="Découvrez nos archets pour violons, disponibles à la vente ou en location. Nous vous proposons également des prestations d'entretien de vos archets de violons" />
    <?php } if($categorie=="archet" && $categorie_id==7 ) { ?>
    <title>Nos archets : découvrez nos archets d'altos à Toulouse</title>
    <meta name="description"
        content="Découvrez nos archets pour altos, disponibles à la vente ou en location. Nous vous proposons également des prestations d'entretien pour vos archets d'altos" />
    <?php } if($categorie=="archet" && $categorie_id==8 ) { ?>
    <title>Nos archets : découvrez nos archets de violoncelles à Toulouse</title>
    <meta name="description"
        content="Découvrez nos archets pour violoncelles, disponibles à la vente ou en location. Nous vous proposons également des prestations d'entretien pour vos archets de violoncelles" />
    <?php } if($categorie=="archet" && $categorie_id==9 ) { ?>
    <title>Nos archets : découvrez nos archets de contrebasses à Toulouse</title>
    <meta name="description"
        content="Découvrez nos archets pour contrebasses, disponibles à la vente ou en location. Nous vous proposons également des prestations d'entretien pour vos archets de contrebasses" />
    <?php } if($categorie=="archet" && $categorie_id==10 ) { ?>
    <title>Nos archets : découvrez nos archets d'instruments baroques à Toulouse</title>
    <meta name="description"
        content="Découvrez nos archets pour instruments baroques, à la vente ou en location. Nous vous proposons également des prestations d'entretien pour vos archets d'instruments baroques" />

    <?php } if($categorie=="accessoire" && $categorie_id==11) { ?>
    <title>Découvrez notre sélection d'accessoires pour violons à Toulouse</title>
    <meta name="description"
        content="Notre atelier vous propose également une sélection d'accessoires pour votre violon afin de répondre à toutes les demandes : entretien, confort, transport ..." />
    <?php } if($categorie=="accessoire" && $categorie_id==12 ) { ?>
    <title>Découvrez notre sélection d'accessoires pour altos à Toulouse</title>
    <meta name="description"
        content="Notre atelier vous propose également une sélection d'accessoires pour altos, afin de répondre à toutes les demandes : entretien, confort, transport ..." />
    ...
    <meta name="description"
        content="Notre atelier vous propose également une sélection d'accessoires pour votre violoncelle afin de répondre à toutes les demandes : entretien, confort, transport ..." />
    ...
    <meta name="description"
        content="Notre atelier vous propose également une sélection d'accessoires pour votre contrebasse afin de répondre à toutes les demandes : entretien, confort, transport ..." />
    ...
    <meta name="description"
        content="Notre atelier vous propose également une sélection d'accessoires pour votre instrument baroque afin de répondre à toutes les demandes : entretien, confort, transport ..." />
    ...
    <meta name="description"
        content="Les prestations de lutherie proposées par l'atelier Dalle Carbonare : vente, location, expertise, restauration, fabrication d'instruments de musique" />
    <?php } if($url=="/focus.php") { ?>
    <title>Focus : découvrez régulièrement une activité ou un projet spécifique</title>
    <meta name="description"
        content="Dans cette rubrique, l'atelier Dalle Carbonare vous présente des activités spécifiques ou un projet particulier autour de la fabrication & restauration d'instruments" />
    <?php } if($url=="/contacter-atelier-lutherie-toulouse.php") { ?>
    <title>Contacter L'atelier de lutherie Dalle Carbonare, à Toulouse</title>
    <meta name="description"
        content="Contacter notre atelier, situé au coeur de Toulouse, pour nous soumettre vos questions ou demandes. Notre équipe se tient à votre disposition pour y répondre !" />
    <?php } ?>
        ...
        <header id="header">
            <div class="container">
                ...
                <nav class="nav-drop">
                    <div class="nav-left">
                        <ul class='link-list'>
                            <li <?if($url=="/index.php" ) {echo "class='active'" ;}?>><a href="index.php">Accueil</a>
                            </li>
                            <li <?if($url=="/atelier-dalle-carbonare-luthier-toulouse.php" ) {echo "class='active'" ;}?>
                                ><a href="atelier-dalle-carbonare-luthier-toulouse.php">Atelier</a></li>
                            <li <?if($categorie=="instrument" ) {echo "class='active'" ;}?>><a
                                    href="liste.php?categorie=instrument">Instruments</a></li>
                            <li <?if($categorie=="archet" ) {echo "class='active'" ;}?>><a
                                    href="liste.php?categorie=archet">Archets</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="nav-right">
                        ...
                        <ul class='link-list'>
                            <li <?if($categorie=="accessoire" ) {echo "class='active'" ;}?>><a
                                    href="liste.php?categorie=accessoire">Accessoires</a></li>
                            <li class="<?if($url=="/prestations-luthier-toulouse.php") {echo "active " ;}?>drop-down">
                                <a href="prestations-luthier-toulouse.php" class="subnav-drop-opener">Prestations <i
                            ...
                            <li <?if($url=="/contacter-atelier-lutherie-toulouse.php" ) {echo "class='active'" ;}?>><a
                                    href="contacter-atelier-lutherie-toulouse.php">Contact</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
