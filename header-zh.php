                    ...
                    <div class="nav-left">
                        <ul class='link-list'>
                            <li <?if($url=="/index.php" ) {echo "class='active'" ;}?>><a
                                    href="index.php?lang=chinese">主页</a></li>
                            <li <?if($url=="/atelier-dalle-carbonare-luthier-toulouse.php" ) {echo "class='active'" ;}?>
                                ><a href="atelier-dalle-carbonare-luthier-toulouse.php?lang=chinese">工作室</a></li>
                            <li <?if($categorie=="instrument" ) {echo "class='active'" ;}?>><a
                                    href="liste.php?categorie=instrument&lang=chinese">提琴 (FR)</a></li>
                            <li <?if($categorie=="archet" ) {echo "class='active'" ;}?>><a
                                    href="liste.php?categorie=archet&lang=chinese">琴弓 (FR)</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="nav-right">
                        ...
                        <ul class='link-list'>
                            <li <?if($categorie=="accessoire" ) {echo "class='active'" ;}?>><a
                                    href="liste.php?categorie=accessoire&lang=chinese">配件 (FR)</a></li>
                            <li class="<?if($url=="/prestations-luthier-toulouse.php") {echo "active " ;}?>drop-down">
                                <a href="prestations-luthier-toulouse.php?lang=chinese" class="subnav-drop-opener">服務 <i
