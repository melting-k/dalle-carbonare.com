        ...
        <div class="container">
            <section class="visual-large">
                <div class="text-holder">
                    ...
                    <p>Installé dans le cœur historique de Toulouse depuis plus de 20 ans, l’Atelier Dalle Carbonare met
                        à votre disposition des produits et services de qualité au travers d’une équipe de luthiers
                        passionnés et spécialisés qui sauront vous écouter, vous conseiller et prendre soin de vos
                        instruments et archets.
                        <br> L’atelier vous propose un large choix d’instruments mais aussi un panel varié de
                        prestations.
                    </p>
                ...
                <div class="img-holder">
                    <div class="img-box"
                        style="background-image:url('build/images/tradition-savoir-faire-luthier-toulouse.jpg')"></div>
                </div>
            </section>
            ...
            <section class="visual-light">
                <div class="img-holder">
                    <div class="img-box"
                        style="position:relative; background-image:url('build/images/actualites-luthier-toulouse.jpg')">
                        <a href="https://www.youtube.com/watch?v=tQ2JOxE2eRo&feature=youtu.be&fbclid=IwAR2LiILtvKP96HUhgoNSTad12k8Rf-7bgNsPiL1uCwHgV1nbC3GNN5mdwXI"
                            target="_blank"
                            style="display:block; position:absolute; top:0; right:0; bottom:0; left:0;"></a>
                    </div>
                </div>
                <div class="text-holder">
                    <h1>actualités</h1>
                    <h2 class="small-h2">Reportage de France Télévision</h2>
                    <p>Découvrez le reportage de France 3, dans notre atelier, sur les chevalets du Gers qui font vibrer
                        les violons du monde entier !
                        <br /><br />
                        <a href="https://www.youtube.com/watch?v=tQ2JOxE2eRo&feature=youtu.be&fbclid=IwAR2LiILtvKP96HUhgoNSTad12k8Rf-7bgNsPiL1uCwHgV1nbC3GNN5mdwXI"
            ...
            <section class="thumb-holder">
                ...
                <div class="thumb-wrapper">
                    <a href="atelier-dalle-carbonare-luthier-toulouse.php" class="thumb">
                        ...
                        <div class="text-holder">
                            <h4>NOTRE ATELIER</h4>
                            <p>Toute une équipe passionnée à votre service pour régler, entretenir, restaurer vos
                                instruments et entretenir vos archets.</p>
                        </div>
                    </a>
                    <a href="liste.php?categorie=instrument" class="thumb">
                        <div class="img-holder">
                            <img src="build/images/nos-instruments-violons-violoncelles-altos-contrebasses.jpg"
                                alt="image description">
                        </div>
                        <div class="text-holder">
                            <h4>NOS INSTRUMENTS</h4>
                            <p>A louer ou à vendre, un large choix de violons, altos, violoncelle ou contrebasses à
                                découvrir.</p>
                        </div>
                    </a>
                    <a href="prestations-luthier-toulouse.php" class="thumb">
                        ...
                        <div class="text-holder">
                            ...
                            <p>De la fabrication d’instruments neuf à l’expertise d’instruments anciens en passant par
                                la location ou la vente d’accessoires l’atelier Dalle Carbonare est au service de la
            ...
            <section class="separeted-block">
                ...
                <div class="text-holder">
                    <p>
                        L'atelier vous propose d'expertiser vos instruments et archets pour les faire assurer ou pour
                        une évaluation pour une vente. N'hésitez pas à nous faire parvenir dans un premier temps des
                        photos par mail avant de vous déplacer.
                    </p>
                    <a href="prestations-luthier-toulouse.php" class="btn btn-brown">En savoir plus <i
